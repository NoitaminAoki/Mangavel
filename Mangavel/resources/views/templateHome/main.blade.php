        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/1.jpg') }}" alt="Speaker 1" class="img-fluid">
                <div class="details">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/2.jpg') }}" alt="Speaker 2" class="img-fluid">
                <div class="details">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/3.jpg') }}" alt="Speaker 3" class="img-fluid">
                <div class="details">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/4.jpg') }}" alt="Speaker 4" class="img-fluid">
                <div class="details">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/5.jpg') }}" alt="Speaker 5" class="img-fluid">
                <div class="details">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker">
                <img src="{{ asset('img/home/speakers/6.jpg') }}" alt="Speaker 6" class="img-fluid">
                <div class="details">
          ...
          <div class="tab-content row justify-content-center">
            ...
            <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/1.jpg') }}" alt="Brenden Legros">
                  </div>
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/2.jpg') }}" alt="Hubert Hirthe">
                  </div>
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/3.jpg') }}" alt="Cole Emmerich">
                  </div>
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/4.jpg') }}" alt="Jack Christiansen">
                  </div>
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/5.jpg') }}" alt="Alejandrin Littel">
                  </div>
              ...
              <div class="row schedule-item">
                ...
                <div class="col-md-10">
                  <div class="speaker">
                    <img src="{{ asset('img/home/speakers/6.jpg') }}" alt="Willow Trantow">
                  </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="hotel">
                <div class="hotel-img">
                  <img src="{{ asset('img/home/hotels/1.jpg') }}" alt="Hotel 1" class="img-fluid">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="hotel">
                <div class="hotel-img">
                  <img src="{{ asset('img/home/hotels/2.jpg') }}" alt="Hotel 2" class="img-fluid">
                </div>
          ...
          <div class="row no-gutters sponsors-wrap clearfix">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/1.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/2.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/3.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/4.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/5.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/6.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/7.png') }}" class="img-fluid" alt="">
              </div>
            </div>
            
            <div class="col-lg-3 col-md-4 col-xs-6">
              <div class="sponsor-logo">
                <img src="{{ asset('img/home/sponsors/8.png') }}" class="img-fluid" alt="">
              </div>
            </div>
